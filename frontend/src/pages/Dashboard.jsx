      ...
      <div className="dash-root">
            ...
            <div className="profile-wrap" ref={profileRef}>
              ...
              {showProfile && (
                <div className="profile-dropdown">
                  ...
                  <button className="dropdown-item" onClick={() => { navigate("/quiz/create"); setShowProfile(false); }}>
                    ➕ Create Quiz
                  </button>
                  ...
                  <button className="dropdown-item danger" onClick={() => { logout(); setShowProfile(false); }}>
                    🚪 Logout
                  </button>
                </div>
              )}
        ...
        <div className="dash-main">
          ...
          <div className="page-header">
            ...
            <button className="btn-create-new" onClick={() => navigate("/quiz/create")}>
              + Create New Quiz
            </button>
          </div>
          ...
          <div className="card">
            ...
            {loadingHistory ? (
              ...
              <div className="empty-state">
                ...
                <button className="empty-btn" onClick={() => navigate("/quiz/create")}>Create Your First Quiz</button>
              </div>
            ) : (
          ...
          <div className="card">
            ...
            {loadingRecent ? (
              ...
              <div className="empty-state">
                ...
                <button className="empty-btn" onClick={() => navigate("/quiz/create")}>Create Quiz</button>
              </div>
            ) : (
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <div className="create-card" onClick={() => navigate("/quiz/create")}>
